...
export default function Home() {
  return (
    <div className="min-h-screen md:m-14 flex items-center justify-center px-4 pt-20 md:pt-0">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6">
            <span className="bg-gradient-to-r text-4xl from-purple-600 via-pink-600 to-blue-600 bg-clip-text text-transparent">
             AI & ML 
            </span>
            <br />
            <span className="text-gray-800 dark:text-white">Fuzail Mansuri</span>
          </h1>
